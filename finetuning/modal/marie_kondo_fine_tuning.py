...
def main():
    ...
    hf_dataset_name = "Jrtej99/mk_chat"
    hf_save_gguf_name = "Jrtej99/Marie-Kondo-MODAL-Q4_K_M-GGUF"
    epochs = 3
...
# run using
# modal run finetuning/modal/marie_kondo_fine_tuning.py
